...
`ifndef CFS_ALIGNER_V
  ...
  module cfs_aligner#(
	parameter integer ALGN_DATA_WIDTH = 32,
    parameter FIFO_DEPTH      = 8,
	parameter integer FIFO_SIZE = $bits(FIFO_DEPTH),
    
    
	localparam integer APB_ADDR_WIDTH    = 16,
    localparam integer APB_DATA_WIDTH    = 32,
    localparam integer ALGN_OFFSET_WIDTH = ALGN_DATA_WIDTH <= 8 ? 1 : $clog2(ALGN_DATA_WIDTH/8),
    localparam ALGN_SIZE_WIDTH   = $clog2(ALGN_DATA_WIDTH/8)+1,
	localparam ALGN_CLR_WIDTH = ALGN_SIZE_WIDTH - ALGN_OFFSET_WIDTH,
	localparam ALGN_TR_WIDTH = (ALGN_SIZE_WIDTH + ALGN_OFFSET_WIDTH)/ALGN_CLR_WIDTH,
	localparam ALGN_SR_WIDTH = $clog2((ALGN_SIZE_WIDTH * ALGN_OFFSET_WIDTH)/ALGN_CLR_WIDTH),
	localparam ALGN_DR_WIDTH = $bits(ALGN_DATA_WIDTH) + 8,
